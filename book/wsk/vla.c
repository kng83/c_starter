//vla tablice z zmienna iloscia argumentow
//int sumuj2d(int, int, int tab[*][*]); tab jest VLA, nazwy pominieto
...
//int sumuj2d(int wiersze, int kolumny, int tab[*][*]); // to tez dziala
int main(void)
{
    int i, j;
    int rw = 3;
